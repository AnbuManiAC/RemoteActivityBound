package com.example.activityremotebind;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent.setComponent(new ComponentName("com.example.remoteservicebind","com.example.remoteservicebind.MyService"));
